...
describe("./message/parser/twitch-message", () => {
  describe("#parseTwitchpMessage", () => {
    const testCases = [
      ...
      {
        irc:
          `${String.raw`@badge-info=predictions/<<<<<<\sHEAD[15A⸝asdf/test,founder/17;badges=predictions/pink-2,vip/1,founder/0,bits/1;` 
      ...
      },
      {
        irc:
          ...
          String.raw`msg-param-should-share-streak=0;msg-param-sub-plan-name=The\sWhatevas;` 
          }msg-param-sub-plan=Prime;room-id=408892348;subscriber=1;system-msg=fletchercodes${ 
          String.raw`\ssubscribed\swith\sTwitch\sPrime.;tmi-sent-ts=1551486064328;` 
      ...
      },
      {
        irc:
          ...
          String.raw`s8c\sdc\sc9\s4d\s96\s73\sd0\sad\s40\s52\sf3\s19\s02;` 
          }msg-param-sender-count=1;msg-param-sub-plan=1000;room-id=38884180;subscriber=1;${ 
          String.raw`system-msg=yurixxxxx14\sis\sgifting\s1\sTier\s1\sSubs\sto\susertag's\scommunity!` 
          }${String.raw`\sThey've\sgifted\sa\stotal\sof\s1\sin\sthe\schannel!;tmi-sent-ts=1633549401426;` 
